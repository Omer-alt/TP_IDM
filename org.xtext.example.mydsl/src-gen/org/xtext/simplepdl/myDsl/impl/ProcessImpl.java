 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.simplepdl.myDsl.impl.ProcessImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.simplepdl.myDsl.impl.ProcessImpl#getProcessElements <em>Process Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements org.xtext.simplepdl.myDsl.Process
{
  /**
  ...
  {
    return MyDslPackage.Literals.PROCESS;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PROCESS__NAME, oldName, name));
  }
  ...
  public EList<ProcessElement> getProcessElements()
  {
    ...
    {
      processElements = new EObjectContainmentEList<ProcessElement>(ProcessElement.class, this, MyDslPackage.PROCESS__PROCESS_ELEMENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.PROCESS__PROCESS_ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.PROCESS__NAME:
        return getName();
      case MyDslPackage.PROCESS__PROCESS_ELEMENTS:
